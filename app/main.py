...
def getMeetings():
    ...
    meetings = [meeting for meeting in meetings if (meeting['start_time'].split("-")[1] == '05' or meeting['start_time'].split("-")[1] == '06')]
    meetings = meetings.sort(reverse=True, key=sortMeetingList)
